-- Система классов для lua
-- Идея взята отсюда: https://github.com/luvit/luvit/blob/master/deps/core.lua#L78
...
---     assert(instanceof(Object, Object))
---     assert(instanceof(Emitter, Object))
function libclass.instanceof(obj, class)
